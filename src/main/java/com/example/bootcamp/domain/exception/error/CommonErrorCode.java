...
public enum CommonErrorCode implements IErrorCode{
    ...
    VALIDATION_ERROR("ERR_VALIDATION", "Validation error", HttpStatus.BAD_REQUEST.value(), ErrorBootcamp.VALIDATION),
    INVALID_INPUT("ERR_INVALID_INPUT", "Invalid input data", HttpStatus.BAD_REQUEST.value(),  ErrorBootcamp.VALIDATION),
    ...
    // Resource errors
    RESOURCE_NOT_FOUND("ERR_NOT_FOUND", "Resource not found", HttpStatus.NOT_FOUND.value(), ErrorBootcamp.RESOURCE),
    RESOURCE_ALREADY_EXISTS("ERR_DUPLICATE_RESOURCE", "Resource already exists", HttpStatus.CONFLICT.value(), ErrorBootcamp.RESOURCE),
    ...
    // Data access errors
    DATA_ACCESS_ERROR("ERR_DATA_ACCESS", "Data access error", HttpStatus.INTERNAL_SERVER_ERROR.value(), ErrorBootcamp.DATA_ACCESS),
    DATABASE_ERROR("ERR_DATABASE", "Database error", HttpStatus.INTERNAL_SERVER_ERROR.value(), ErrorBootcamp.DATA_ACCESS),

    // System errors
    INTERNAL_ERROR("ERR_INTERNAL_SERVER", "Internal server error", HttpStatus.INTERNAL_SERVER_ERROR.value(), ErrorBootcamp.SYSTEM),
    SERVICE_UNAVAILABLE("ERR_SERVICE_UNAVAILABLE", "Service unavailable", HttpStatus.SERVICE_UNAVAILABLE.value(), ErrorBootcamp.SYSTEM),

    // External service errors
    EXTERNAL_SERVICE_ERROR("ERR_EXTERNAL_SERVICE", "External service error", HttpStatus.INTERNAL_SERVER_ERROR.value(), ErrorBootcamp.EXTERNAL_SERVICE),
    EXTERNAL_SERVICE_TIMEOUT("ERR_EXTERNAL_SERVICE_TIMEOUT", "External service timeout", HttpStatus.GATEWAY_TIMEOUT.value(), ErrorBootcamp.EXTERNAL_SERVICE);
    ...
    private final ErrorBootcamp errorBootcamp;


    @Override
    public ErrorBootcamp getBootcamp() {
        return null;
    }
}
